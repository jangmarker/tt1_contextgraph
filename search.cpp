...
search::SearchResultPtr search::search(const Database & db, const Word& word, NeighborCount neighborCount, Depth depth)
{
    if (depth == 0) {
        ...
        for (const Word& neighborWord : neighborWords) {
